...
list.of.packages <- c("RColorBrewer","qgraph","dynamicTreeCut","fclust","svglite","gridBase","igraph","BiocManager","tidyr","parallel","reshape2","stringr","ggplot2","snow","dplyr","networkD3","htmlwidgets","data.table","poolr","VarianceGamma","magrittr","pkgconfig")
